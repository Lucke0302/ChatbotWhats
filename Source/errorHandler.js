const ERROR_DICTIONARY = {
    ...
    "INVALID_INITIAL" : "❌ Inicial inválido! Escolha um da lista. Ex: !poke2 escolher squirtle",
    "DEX_ERROR": "⚠️ Erro na Pokédex. O Professor Carvalho derrubou os dados.",
    "POKE_HEAL_BATTLE": "🚫 Você não pode curar seus Pokémon no meio de uma batalha! Fuja ou termine a luta primeiro.",
    "POKE_SLOT_EMPTY": `🚫 Não tem ninguém nesse slot do seu time.`,
    "ALREADY_HAVE_MON" : "🚫 Você já é um treinador! Digite *!poke2 hunt* para explorar.",
